!(({ languages, util }) => {
  ...
  ["c", { lang: "c++", alias: "cpp" }, "fortran"].forEach((e) => {
    let t = e;
    if (("string" != typeof e && ((t = e.alias), (e = e.lang)), languages[t])) {
      const a = {};
      (a[`inline-lang-${t}`] = {
        pattern: RegExp(
          "%< *-\\*- *<lang>\\d* *-\\*-[^]+?%>".replace(
        ...
        (a[`inline-lang-${t}`].inside.rest = util.clone(languages[t])),
        languages.insertBefore("pure", "inline-lang", a);
    }
  }),
    languages.c &&
