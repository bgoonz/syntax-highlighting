hljs.registerLanguage("latex", (() => {
  ...
  return e => {
    ...
    const t = { begin: /\{/, end: /\}/, relevance: 0, contains: ["self", ...a] };
    const i = e.inherit(t, { relevance: 0, endsParent: !0, contains: [t, ...a] });
      ...
      contains: [
        ...
        ...[].concat(
          ...["", "\\*"].map((e) => [
            ...
            g("filecontents" + e, o(c, u("filecontents" + e))),
            ...["", "B", "L"].map((n) =>
              g(n + "Verbatim" + e, o(l, u(n + "Verbatim" + e)))
            ),
          ])
        ),
        g("minted", o(l, o(c, u("minted")))),
        ...a,
      ],
    };
  };
