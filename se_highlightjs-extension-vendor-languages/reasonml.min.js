hljs.registerLanguage(
  ...
  (() => {
    ...
    return (e) => {
      ...
      const c = { className: "operator", relevance: 0, begin: s };
      const o = [{ className: "identifier", relevance: 0, begin: n }, c, t];
      ...
      const u = {
        ...
        relevance: 0,
        contains: [d, c, { relevance: 0, className: "constructor", begin: a }],
      };
