hljs.registerLanguage("routeros", (() => {
  ...
  return e => {
    ...
    const n = "true false yes no nothing nil null";
    ...
    return {
      ...
      keywords: {
        ...
        literal: n,
        keyword:
          `${r} :${r.split(" ").join(" :")} :${"global local beep delay put len typeof pick log time set find environment terminal error execute parse resolve toarray tobool toid toip toip6 tonum tostr totime"
  .split(" ")
  .join(" :")}`,
      },
      contains: [
