hljs.registerLanguage(
  ...
  (() => {
    "use strict";
    return ({ BACKSLASH_ESCAPE, HASH_COMMENT_MODE }) => {
      ...
      const n = { keywords: t, illegal: /<\// };
      const a = { className: "subst", begin: /\$\(/, end: /\)/, keywords: t };
      const i = { className: "variable", begin: `\\$${r}` };

      const o = {
        className: "string",
        contains: [BACKSLASH_ESCAPE, a, i],
        variants: [
      ...
      const l = { className: "meta", begin: `@${r}` };
      return (
        (n.name = "Julia"),
        (n.contains = [
          {
