hljs.registerLanguage("typescript", (() => {
  ...
  return r => {
    ...
    const o = { className: "meta", begin: "@[A-Za-z$_][0-9A-Za-z$_]*" };

    const l = ({contains}, n, a) => {
      const s = contains.findIndex(({label}) => label === n);
      if (-1 === s) throw Error("can not find mode to replace");
      contains.splice(s, 1, a);
    };
    ...
    (b.contains.find(({className}) => "function" === className).relevance = 0),
    Object.assign(b, {
      name: "TypeScript",
      aliases: ["ts"],
    }),
